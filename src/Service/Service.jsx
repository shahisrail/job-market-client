    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-5 gap-5">
        <div
          ...
          className="relative flex hover:bg-slate-300  text-gray-700 bg-white shadow-md  p-2 items-center rounded-xl bg-clip-border"
        >
          <img
        ...
        <div
          ...
          data-aos-easing="ease-out-cubic"
          data-aos-duration="2000"
          className="relative flex p-2 hover:bg-slate-300 text-gray-700 bg-white shadow-md  items-center rounded-xl bg-clip-border"
        >
          <img
        ...
        <div
          ...
          data-aos-easing="ease-out-cubic"
          data-aos-duration="2000"
          className="relative p-2 flex hover:bg-slate-300 text-gray-700 bg-white shadow-md  items-center rounded-xl bg-clip-border"
        >
          <img
